...
var commands = {
   ...
   'hello (who are you)': function() { var worte = new SpeechSynthesisUtterance("Hello, I am Aubrey");
worte.lang = "en-GB";
...
var commands2 = {
   ...
   '(aubrey) Who made you': function() { var worte = new SpeechSynthesisUtterance("Sam bolton");
worte.lang = "en-GB";
window.speechSynthesis.speak(worte);  }
